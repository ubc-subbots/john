#ifndef JOHN_CONTROL__THRUST_ALLOCATOR
#define JOHN_CONTROL__THRUST_ALLOCATOR
...
#define MAX_THRUSTERS 6 // placehodler
...
{      
    ...
    private:
         ...
         * use armadillo or eigen for matrix operations
         * thrust = pinv(A)*tau
         * 
         ...
         * Currently uses opencv library, maybe different one
         ...
         * a thruster. 
         * 
         * TODO: linear force to power level conversion... -> need to determine if this is optimal
         *  there are some cases where nonlinear may work better, if we want delicate movement
         *
         * maybe piecewise, high res for low force values 
         *  low re for high force values (effiecient encoding)
         * @param force 
         * @return uint32_t 
         */
